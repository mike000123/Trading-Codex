...
_PARAM_META: dict[str, dict] = {
    ...
    "gold_fair_value_bullish_slope_min": {"label": "Fair-value bullish slope %", "help": "Minimum month-over-month fair-value slope required before the fair-value regime is treated as bullish."},
    "gold_fair_value_bearish_slope_max": {"label": "Fair-value bearish slope %", "help": "Maximum month-over-month fair-value slope required before the fair-value regime is treated as bearish."},
    "gold_fair_value_undervalued_gap_pct": {"label": "Fair-value undervalued gap %", "help": "How much below fair value GLD can be while still being treated as supportive for bullish bias. Larger values make the model more tolerant of temporarily stretched prices."},
    "gold_fair_value_overvalued_gap_pct": {"label": "Fair-value overvalued gap %", "help": "Minimum amount by which GLD must sit above fair value before the bearish fair-value bias is allowed to activate."},
...
def render_strategy_params(
    ...
    prominent_bools = ["require_cross", "event_target_short_enabled", "intraday_pullback_short_enabled", "shock_reversal_short_enabled", "cascade_breakdown_short_enabled", "shock_rebound_long_enabled"]
